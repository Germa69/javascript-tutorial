...
/**
  // TODO: B2: Destructuring Object: Cấu trúc đối tượng trong ES6
  //? http://bit.ly/2OVRWDq
*/
...
//3.1: typeof the outermost layer is Object
// console.log(typeof jobSearch)

//3.2:
// console.log(typeof jobSearch.hits); //! Hits là Array
...
//     var enter = prompt('Enter a keyword: ')

//     if (dictionary[enter]) {
//         alert(`${enter}\n${enter}`);
//     } else {
//         alert(`We could not find your word: ${enter}`)
//     }
// }
...
// if (enter == null || enter == undefined || enter == '') {
//     alert('Nothing!')
// } else if (dictionary[enter]) {
//     alert(`${enter} \n ${dictionary[enter]}`);
...
//     }
// } else {
//     var updated = prompt(`We could not find your word: ${enter}, leave your explanation`);

//     var updatedDataNumber = Number(updated);
//     var updatedDataString = String(updated);

//     if (updatedDataNumber) {
//         dictionary[enter] = Number(updated);
//     } else if (updatedDataString) {
//         dictionary[enter] = String(updated);
//     }
...
/**
  // TODO: B5: Initialize a variable named products, containing an array of products, each product has a name, price, brand, category, and color 
*/
...
//     console.log('-------------------------')
//     console.log(`Name: ${products[prd].name}`)
//     console.log(`Price: ${products[prd].price}`)
// }
...
// for(let prd in products){
//   console.log(`#${i++}.${products[prd].name}`)
//   console.log(`Price: ${products[prd].price}`)
// }
...
// do{
//   var pos = Number(prompt('Enter product position:'))
// }while(isNaN(pos) || pos == '')


// let productM = products[pos - 1]
// console.log(`Name: ${productM.name}`)
// console.log(`Brand: ${productM.brand}`)
// console.log(`Price: ${productM.price}`)
// console.log(`Color: ${productM.color}`)
// console.log(`Category: ${productM.category}`)

//* 5.3: Write a script printing/logging out the products based on category input by users

// var catagoies = prompt('Enter your category?')

// for(let i = 0; i < products.length; i++){
//   if(catagoies === products[i].category){
//     console.log('----------------------------')
...
// for(let i = 0; i < products.length; i++){
//   if(products[i].category.indexOf(catagoies)){
//     console.log('----------------------------')
//     console.log(`Name: ${products[i].name}`)
//     console.log(`Price: ${products[i].price}`)
//   }
...
// let nhapValueProvider = prompt('Enter provider: ');

// for (let i = 0; i < products.length; i++){
//     if (nhapValueProvider === products[i].providers){
//         console.log(`---------------------------------`);
//         console.log(`Name: ${products[i].name}`);
...
/**
  // TODO: B6: Write a script to store and process the learning tasks to become a front-end developer
*/
...
for(let sub in learningTasks){
  console.log(`#${i++}.${learningTasks[sub].name}`)
  console.log(`   Complete: ${learningTasks[sub].complete}`)
}

console.log(`-------------------------------------------------------------------`)

//* 6.2/6.3/6.4/6.5: Let users add, update, delete, complete task
var Tasks = prompt('Enter your command (New, Delete, Update, Complete)')

if(Tasks == 'New' || Tasks == 'new' || Tasks == 'n'){
  var TasksValue = prompt('Enter new task')
  ...
  for(let i = 0; i < learningTasks.length; i++){
    console.log(`${i+1}. [ ${learningTasks[i].complete == 'true' ? 'X' : ''} ] ${learningTasks[i].name}`)
  }

}else if(Tasks == 'Delete' || Tasks == 'delete' || Tasks == 'd'){
  var posTasks = prompt('Enter position')

  for (let i = 0; i < learningTasks.length; i++) {
    if (learningTasks[posTasks] === learningTasks[i]) {
        learningTasks.splice(i, 1)
...
}else if(Tasks == 'Update' || Tasks == 'update' || Tasks == 'u'){
  var posTasks = prompt('Enter position');

  for (let i = 0; i < learningTasks.length; i++){
    if (learningTasks[posTasks] === learningTasks[i+1]){
        var nhapNewName =  prompt('Enter new name: ');
        learningTasks[i].name = nhapNewName;
    }
...
}else if(Tasks == 'Complete' || Tasks == 'complete' || Tasks == 'c'){
  var posTasks = prompt('Enter position');

  for (let i = 0; i < learningTasks.length; i++){

      if (learningTasks[posTasks] === learningTasks[i+1]){
          learningTasks[i].complete = 'true';
      }
  }
...
/** 
  // TODO: B7: Given the object
*/


/**
  //!NOTE: Sự khác nhau giữa for..in và for...of
  - VD1:
    for(let i in products){
      console.log(i) // for..in: In ra tất cả key của object trong mảng 
    }

    for(let i of products){
      console.log(i) // for..of: In ra tất cả giá trị của object
    }

  - VD2: Néu products[i] 
    for(let i in products){
      console.log(products[i]) // for..in: In ra tất cả giá trị của object trong mảng 
    }

    for(let i of products){
      console.log(products[i]) // for..of: Giá trị trả về underfined
    }
  //! Cách lấy giá trị trong mảng chứa 1 objects
    C1: products[vị trí mảng]['category']
    C2: products[vị trí mảng].category
*/
...
// Link: http://bit.ly/2OySz66 (link bài tập)
